...
LevelLoader::LevelLoader( Graphics &graphics ): graphics(&graphics) {}
	...
	for ( int i = 0; i < width * height; i++ ) {
		if ( !isWhite(getPixelColour(i)) and isPixelUsed(i) == -1 ) {
			...
			if ( isGoal(getPixelColour(i)) ) {
                ...
                level->add( std::make_unique<Gate>( Box{center,halfLength,{}}, int(getPixelColour(i).z), int(getPixelColour(i).y) % 10) );
			}
                ...
                level->add( std::make_unique<Button>( Box{center,halfLength,{}}, int(getPixelColour(i).y) % 10) );
			}
			else {
				startPosX = float((i % width) - middleX);
				startPosY = float(middleY) - float(floor(i / width));
...
[[nodiscard]] glm::vec3 LevelLoader::getPixelColour( int index ) const noexcept {
	// Convert to RGB
	index *= 3;
...
[[nodiscard]] int LevelLoader::isPixelUsed( int index ) const noexcept {
...
[[nodiscard]] inline bool LevelLoader::isWhite( glm::vec3 const &pixelColour ) const noexcept {
	return pixelColour.x == 255 and pixelColour.y == 255 and pixelColour.z == 255;
}

[[nodiscard]] inline bool LevelLoader::isGoal( glm::vec3 const &pixelColour ) const noexcept {
	return pixelColour.x == 0 and pixelColour.y == 0 and pixelColour.z == 255;
}

[[nodiscard]] inline bool LevelLoader::isEnemy( glm::vec3 const &pixelColour ) const noexcept {
	return pixelColour.x == 255 && pixelColour.y == 0 && pixelColour.z == 0;
}

[[nodiscard]] inline bool LevelLoader::isStartPoint( glm::vec3 const &pixelColour ) const noexcept {
	return pixelColour.x == 0 && pixelColour.y == 255 && pixelColour.z == 0;
}
[[nodiscard]] inline bool LevelLoader::isBouncy( glm::vec3 const &pixelColour ) const noexcept {
	return pixelColour.x == 255 && pixelColour.y == 0 && pixelColour.z == 255;
}

[[nodiscard]] inline bool LevelLoader::isHeavy( glm::vec3 const &pixelColour ) const noexcept {
	return pixelColour.x == 192 && pixelColour.y == 192 && pixelColour.z == 192;
}

[[nodiscard]] inline bool LevelLoader::isSticky( glm::vec3 const &pixelColour ) const noexcept {
	return pixelColour.x == 0 && pixelColour.y == 64 && pixelColour.z == 0;
}

[[nodiscard]] inline bool LevelLoader::isNone( glm::vec3 const &pixelColour ) const noexcept {
	return pixelColour.x == 128 && pixelColour.y == 128 && pixelColour.z == 0;
}

[[nodiscard]] inline bool LevelLoader::isPlatform( glm::vec3 const &pixelColour ) const noexcept {
	return !(isEnemy(pixelColour) || isStartPoint(pixelColour) || isGoal(pixelColour) || isWhite(pixelColour));
}

[[nodiscard]] inline bool LevelLoader::isMovingPlatform( glm::vec3 const &pixelColour ) const noexcept {
	return pixelColour.x == 0 && pixelColour.y == 255 && pixelColour.z >= 120 && pixelColour.z <= 130;
}

[[nodiscard]] inline bool LevelLoader::isButton( glm::vec3 const &pixelColour ) const noexcept {
